			...
			<div class="rs_content">
				<form method="post" action="handle_add.do">
					...
					<div data-toggle="distpicker" class="address_content">
						...
						<select	 id="recvProvince"	name="recvProvince" 
							onchange="getCities()">
						 ...
						 城市：<select  id="recvCity" name="recvCity">
							<option value="0">---- 选择市 ----</option>
						</select>
						区/县：<select  id="recvArea"
							name="recvArea">
					...
					<div class="address_tel">
						<span class="red">*</span><span class="kuan">手机号码：</span><input
							type="tel" id="receiverMobile" name="recvPhone" />固定电话：<input
...
<script type="text/javascript">
	...
	function getCities() {
		...
		alert("provinceCode :" + provinceCode);
		// 判断选中的是否是默认项
		if (provinceCode == 0) {
			// 如果选择的是默认项，则"市"和"区"列表还原为初始状态
			$("#recvCity").empty();
			$("#recvArea").empty();
