			...
			<div class="rs_content">
				<form id="uploadForm" enctype="multipart/form-data">
					...
					<div class="rs_content_username">
						...
						<input name="username" id="username" class="ed_username" value=""
					...
					<div class="rs_content_sex">
						...
						<c:if test="${user.gender==1 }">
							<span><input type="radio" name="gender" value="1"
								checked="checked" />男</span>
							<span><input type="radio" name="gender" value="0" />女</span>
						</c:if>

						<c:if test="${user.gender==0 }">
							<span><input type="radio" name="gender" value="1" />男</span>
							<span><input type="radio" name="gender" value="0"
								checked="checked" />女</span>
						</c:if>
                ...
                <span class="women">
					...
					<!--保存按钮-->
					<div class="save" onclick="changeInfo()">保存更改</div>
				</form>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	function changeInfo() {
		...
		var phone = $("#phone").val();
		var email = $("#email").val();
		var data = "username=" + username + "&gender=" + gender + "&phone="
				+ phone + "&email=" + email; */
		// 提交ajax请求并处理结果
		$.ajax({
			"url" : url,
